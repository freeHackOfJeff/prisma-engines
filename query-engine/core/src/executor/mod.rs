...
use crate::{query_document::Operation, response_ir::Responses, schema::QuerySchemaRef, CoreResult};
use async_trait::async_trait;

#[async_trait]
pub trait QueryExecutor {
    async fn execute(&self, query_doc: Operation, query_schema: QuerySchemaRef) -> CoreResult<Responses>;
